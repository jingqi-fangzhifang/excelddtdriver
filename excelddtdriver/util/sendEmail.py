...
import os, sys
from excelddtdriver.config import setting
import smtplib
...
def send_mail(file_new):
    ...
    msg.attach(att)
    msgtext = MIMEText(mail_body, 'templates', 'utf-8')
    msg.attach(msgtext)
    msg['Subject'] = SUBJECT
    msg['from'] = SENDER
    msg['to'] = RECEIVER
...
if __name__ == "__main__":
    # send_mail(new_report("D:\\file\\pWorkSpace\excelddtdriver\\report"))
    send_mail("D:\\file\\pWorkSpace\excelddtdriver\\report\\result.html")
